                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Tambah Kategori Inventaris</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal" method="POST">
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputNamaKategori3" name="nama_kategori" placeholder="Masukkan Nama Kategori" required autofocus>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputDeskripsi3" class="col-sm-2 col-form-label">Deskripsi</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="inputDeskripsi3" name="deskripsi" placeholder="Masukkan Deskripsi Kategori" required></textarea>
                                    </div>
                                </div>
                            </div>
                            <!-- /.card-body -->
